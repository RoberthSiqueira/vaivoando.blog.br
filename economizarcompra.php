            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        <h1>Aprenda a economizar na compra de passagens</h1>
                        <h2 class="subheading">O valor da passagem aérea é um dos grandes vilões na hora de planejar a

viagem. Confira algumas dicas para conseguir o melhor preço.</h2>
